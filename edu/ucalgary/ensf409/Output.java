...
public class Output {
     ...
     * @param arr
     */
    public static void writeFormattedFile(String fileName, String furniture, String type, int count, ArrayList<Furniture> arr) {
     ...
     * @param price
     */
    public static void writeFormattedTerminal(String furniture, String type, int count, ArrayList<Manufacturer> arr) {
